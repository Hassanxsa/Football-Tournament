...
// 3) GET /api/teams/:id/matches
//    All matches this team has played
app.get(
...
// 4) GET /api/teams/:id/tournaments
...
// 2) GET /api/players/:id/matches — all matches for this player’s team(s)
app.get(
