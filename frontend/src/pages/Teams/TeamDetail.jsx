...
const TeamDetail = () => {
  ...
  const isCaptain = (playerId) => {
    ...
    return team.captain_id === playerId || team.captain_id === String(playerId);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="flex-1">
              <h1 className="text-3xl font-bold mb-2">{team?.team_name || 'Team Details'}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-lg text-gray-600">Loading team details...</p>
          </div>
        ) : error ? (
