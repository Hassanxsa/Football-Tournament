...
const Teams = () => {
  ...
  // Using dummy data based on the schema
  const teams = [
    { team_id: 1214, team_name: 'CCM', tournaments: 2, players: 5, matches_played: 8, status: 'Active' },
    { team_id: 1215, team_name: 'KBS', tournaments: 1, players: 3, matches_played: 5, status: 'Active' },
    { team_id: 1216, team_name: 'CEP', tournaments: 2, players: 4, matches_played: 6, status: 'Active' },
    { team_id: 1217, team_name: 'CPG', tournaments: 1, players: 2, matches_played: 3, status: 'Active' },
    { team_id: 1218, team_name: 'CCM', tournaments: 1, players: 6, matches_played: 3, status: 'Inactive' },
    { team_id: 1219, team_name: 'CDB', tournaments: 1, players: 4, matches_played: 3, status: 'Active' },
    { team_id: 1220, team_name: 'CGS', tournaments: 1, players: 3, matches_played: 3, status: 'Active' }
  ];
  ...
  // Team logos (using first letter as placeholder)
  const getTeamLogo = (teamName) => {
    return teamName.charAt(0);
  };

  // Random colors for team backgrounds
              ...
              <div className="p-6">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3 text-center">
                  <div className="border rounded-lg p-2">
                    ...
                    <p className="text-lg font-semibold">{team.tournaments}</p>
                  </div>
                  <div className="border rounded-lg p-2">
                    <p className="text-xs text-gray-500">Players</p>
                    <p className="text-lg font-semibold">{team.players}</p>
                  </div>
                  <div className="border rounded-lg p-2">
                    <p className="text-xs text-gray-500">Matches</p>
                    <p className="text-lg font-semibold">{team.matches_played}</p>
                  </div>
                </div>
